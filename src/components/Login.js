...
const Login =()=>{
    ...
    const login=()=>{
        ...
        axios({
            ...
            url: "https://calo-stonks.herokuapp.com//login"
        }).then(res=>{
    ...
    const register=()=>{
        axios({
            ...
            withCredentials: true,
            url: "https://calo-stonks.herokuapp.com/register"
        }).then(res=>{
    ...
    const signOut = ()=>{
        axios.get("https://calo-stonks.herokuapp.com/logout",{
            withCredentials: true,
            headers: {
    ...
    const checkAuth=()=>{
        ...
        axios.get("https://calo-stonks.herokuapp.com/signedin",{
            withCredentials: true,
            headers: {
                "Content-Type": 'application/json'
            }
